var jsPsychHtmlSliderResponse = (function (jspsych) {
  ...
  class HtmlSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      var html =
        '<div id="jspsych-html-slider-response-wrapper" style="margin: 50px 0px;">';
      html +=
      ...
      html +=
        '<div class="slider-wrapper" style="position: relative; padding: 20px 0;">';
      ...
      // Add vertical lines
      html +=
        '<div class="slider-lines" style="position: absolute; width: 100%; height: 20px; display: flex; justify-content: space-between; pointer-events: none; bottom: 24px; left:2px; z-index: 2;">';
      html +=
        '<div class="line" style="width: 3px; height: 25px; background-color: black;"></div>';
      html +=
        '<div class="line" style="width: 3px; height: 25px; background-color: black;"></div>';
      html +=
        '<div class="line" style="width: 3px; height: 25px; background-color: black;"></div>';
      ...
      for (var j = 0; j < trial.labels.length; j++) {
        ...
        html +=
          '<span class="slider-label-text">' + trial.labels[j] + "</span>";
        html += "</div>";
      }
      html += "</div>";
      html += "</div>";
      ...
      let slider = display_element.querySelector(
